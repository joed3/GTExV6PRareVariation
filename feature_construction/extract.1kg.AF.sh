...
parallel --jobs $nproc "vcftools --gzvcf ${vcfdir}/ALL.{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz --out ${outdir}/{}.indels --keep-only-indels --positions $gtexindel --get-INFO EAS_AF --get-INFO AMR_AF --get-INFO AFR_AF --get-INFO EUR_AF --get-INFO SAS_AF"

for i in chr{1..22}; do echo $i; done | \
parallel --jobs $nproc "vcftools --gzvcf ${vcfdir}/ALL.{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz --out ${outdir}/{}.SNPs --remove-indels --positions $gtexsnp --get-INFO EAS_AF --get-INFO AMR_AF --get-INFO AFR_AF --get-INFO EUR_AF --get-INFO SAS_AF"
