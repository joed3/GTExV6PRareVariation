# =======================================================================================================
# This is a script for generating EDF9c: Correlation between test posterior probabilities and the fraction
#         of tissues
#
# input:
...
#
# output:
#       1. EDF9c.x.pdf (x is either GAM (left) or RIVER (right))
#       2. EDF9c.out.RData
...
ggsave(paste(dir,"/paper_figures/EDF9c.GAM.pdf",sep=""), width=5.5, height=4.5)
...
ggsave(paste(dir,"/paper_figures/EDF9c.RIVER.pdf",sep=""), width=5.5, height=4.5)



# =========== Save data
save.image(file = paste(dir,"/data/EDF9c.out.RData",sep=""))