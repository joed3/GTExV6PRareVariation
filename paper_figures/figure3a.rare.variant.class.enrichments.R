...
vep.estimate <- function(data, features, sv.annots, scale = T){
    ...
    cat.names[cat.names == "Top 1% conserved non-coding"] = "Conserved"
    cat.names[cat.names == "TSS non-coding"] = "TSS"
...
names(colors.final)[names(colors.final) == "Top 1% conserved non-coding"] = "Conserved"
names(colors.final)[names(colors.final) == "TSS non-coding"] = "TSS"
