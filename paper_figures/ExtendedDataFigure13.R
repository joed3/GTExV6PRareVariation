# =======================================================================================================
# This is a script for generating "Extended Data Figure 13"
#
# input:
...
#
# output:
#       1. ExtendedDataFigure13.i.pdf (a, b, c separately)
#       2. ExtendedDataFigure13.out.RData
...
ggsave(paste(dir,"/paper_figures/ExtendedDataFigure13.a.pdf",sep=""),width=6,height=3)
...
ggsave(paste(dir,"/paper_figures/ExtendedDataFigure13.b.pdf",sep=""),width=6,height=3)
...
ggsave(paste(dir,"/paper_figures/ExtendedDataFigure13.c.pdf",sep=""),width=6,height=3)



# =========== Save data
save.image(file = paste(dir,"/data/ExtendedDataFigure13.out.RData",sep=""))