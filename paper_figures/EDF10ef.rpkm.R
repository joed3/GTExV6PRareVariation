# =======================================================================================================
# This is a script for generating EDF10ef (RPKM values)
#
# input:
...
#
# output (a - SBDS, b - GAMT) :
#       1. EDF10ef.rpkm.i.pdf (a, b separately)
#       2. EDF10ef.i.tissue_order.txt: order of tissues in figures (a, b separately) generated
#          by running EDF10ef.Zscores.R
#       3. EDF10ef.rpkm.out.RData
...
obs_tissues_sorted = as.character(unlist(read.table(paste(dir,"/data/EDF10ef.a.tissue_order.txt",sep=""), 
                                                    sep='\t', header = TRUE, na.strings = "NA")))
...
ggsave(paste(dir,"/paper_figures/EDF10ef.rpkm.a.pdf",sep=""), width=6, height=6.5)
...
obs_tissues_sorted = as.character(unlist(read.table(paste(dir,"/data/EDF10ef.b.tissue_order.txt",sep=""), 
                                                    sep='\t', header = TRUE, na.strings = "NA")))
labels_readable = vector()
for (i in 1:length(obs_tissues_sorted)-1) {
  labels_readable = c(labels_readable,
...
ggsave(paste(dir,"/paper_figures/EDF10ef.rpkm.b.pdf",sep=""),width=6,height=2.5)



# =========== Save data
save.image(file = paste(dir,"/data/EDF10ef.rpkm.out.RData",sep=""))
