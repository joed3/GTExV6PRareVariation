# =======================================================================================================
# This is a script for generating EDF 10ef (Z-score values)
#
# input:
...
#
# output:
#       1. EDF10ef.zscore.i.pdf (a, b separately)
#       2. EDF10ef.i.tissue_order.txt: order of tissues in figures (a, b separately)
#       3. EDF10ef.zscore.out.RData
...
write.table(obs_tissues_sorted, file = paste(dir,"/data/EDF10ef.a.tissue_order.txt",sep=""), 
...
ggsave(paste(dir,"/paper_figures/EDF10ef.zscore.a.pdf",sep=""),width=6,height=6.5)
...
labels_readable = c(labels_readable,"Median")
write.table(obs_tissues_sorted, file = paste(dir,"/data/EDF10ef.b.tissue_order.txt",sep=""), 
            quote=FALSE, sep="\t", row.names=FALSE, na="NaN");
...
ggsave(paste(dir,"/paper_figures/EDF10ef.zscore.b.pdf",sep=""),width=6,height=2.5)



# =========== Save data
save.image(file = paste(dir,"/data/EDF10ef.zscore.out.RData",sep=""))